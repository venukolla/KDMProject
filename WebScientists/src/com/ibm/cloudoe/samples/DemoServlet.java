...
public class DemoServlet extends HttpServlet {
	...
	private String username = "1e579bc0-6d94-47ef-8c22-bffb37bbbe1a";	
	private String password = "SbJOkQThH5MT";
	...
	protected void doGet(final HttpServletRequest req, final HttpServletResponse resp) throws ServletException, IOException {
		if (req.getParameter("text") == null || req.getParameter("voice") == null) {
            ...
            NewScientist scientist = cdatabase.getScientist(name);
            
            String query  = scientist.bioinformation;
            
            String queryStr1 = query.replaceAll("[~!@#$%^&*()',.]", " ");
            
            String queryStr = queryStr1.replaceAll(" ", "%20");
...
/*				Request newReq = Request.Get(uri);
			...
			/*	ServletOutputStream servletOutputStream = resp.getOutputStream();
				...
				req.setAttribute("speak",uri.toString());
